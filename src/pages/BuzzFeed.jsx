...
const ReviewPage = ({ userId = "123" }) => {
      ...
      const mockReviews = [
        {
          ...
          rating: 5,
          date: "2024-03-15",
          comment: "Alex taught me photography basics in exchange for cooking lessons. The sessions were incredibly helpful and well-structured. I went from not knowing how to use my DSLR to taking great photos in just three sessions!",
          recommendation: "Highly recommend for photography lessons, especially for beginners. Patient teacher with practical approach.",
          likes: 8,
        ...
        },
        {
          ...
          rating: 4,
          date: "2024-02-28",
          comment: "Alex helped me improve my Spanish conversation skills. We had a good rapport and the sessions were enjoyable. Would definitely swap skills again!",
          recommendation: "Great for intermediate Spanish practice, especially conversational skills.",
          likes: 3,
  ...
  const handleSubmitReview = (e) => {
    ...
    const newReviewObj = {
      ...
      likes: 0,
      skillsExchanged: ["Web Development", "Photography"], 
    };
          ...
          <div className="lg:col-span-1">
                  ...
                  return (
                    <div key={num} className="flex items-center">
                      <div className="flex items-center w-12">
                        <span>{num}</span>
                        <Star size={14} className="ml-1 text-gray-400 fill-gray-400" />
                      </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <form onSubmit={handleSubmitReview}>
                ...
                <div className="mb-6">
                  <label htmlFor="recommendation" className="block text-gray-700 mb-2">
                    ...
                    <div className="p-6">
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="flex text-sm">
                          <div className="px-2 py-1 bg-green-100 text-green-800 rounded-md flex items-center">
                            <span>Skills Exchanged:</span>
                            <span className="ml-1">{review.skillsExchanged.join(" ↔ ")}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      {review.recommendation && (
                        <div className="bg-blue-50 p-3 rounded-md mb-4">
                          ...
                          <p className="text-gray-700 italic">{review.recommendation}</p>
                        </div>
                      )}
